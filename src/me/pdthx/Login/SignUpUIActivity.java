...
import me.pdthx.Setup.PersonalizeActivity;
	...
	public void showSignUpActivity() {
		...
		btnCreateAccount.setOnClickListener(new OnClickListener() {
			public void onClick(View argO) {
				...
				String confirmPassword = ((EditText) findViewById(R.id.confirmPW))
...
//								startActivity(setUp);
								...
								if (signInResponse.Success && response.UserId.equals(signInResponse.UserId)) {
									...
									editor.putString("mobileNumber",
											signInResponse.MobileNumber);
									editor.putString("paymentAccountId",
											signInResponse.PaymentAccountId);
