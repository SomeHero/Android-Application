...
public class UserService {
	...
	public static UserResponse getUser(UserRequest userRequest) {
		...
		if (entity != null) {
			...
			try {
				...
				// userResponse.DeviceToken =
				// jsonResult.getString("deviceToken");
				userResponse.MobileNumber = jsonResult
						.getString("mobileNumber");
				userResponse.EmailAddress = jsonResult
	...
	public static Response changeSecurityPin(
			UserChangeSecurityPinRequest userSecurityPinRequest) {
