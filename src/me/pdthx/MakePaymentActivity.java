...
public final class MakePaymentActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		sdk = ZubhiumSDK.getZubhiumSDKInstance(MakePaymentActivity.this, getString(R.string.secret_key));
			...
			public void onClick(View v) {
				...
				if (isValid) {
					...
					if(prefs.getString("userId", "").length() == 0 || prefs.getString("mobileNumber", "").length() == 0)		{
					    SignInActivity signInActivity = new SignInActivity(MakePaymentActivity.this, mHandler, prefs);
	...
	protected void showSecurityPinDialog() {
		final Dialog d = new Dialog(MakePaymentActivity.this, R.style.CustomDialogTheme);
