...
public class ProfileSetupActivity extends BaseActivity {
	...
	private Handler profileSetupHandler = new Handler() {
		...
		public void showProfileSetup() {
			View view = View.inflate(ProfileSetupActivity.this, R.layout.setup_profile, null);
			...
			ctrlSecurityPin.setOnTouchListener(new OnTouchListener() {
				...
				public boolean onTouch(View v, MotionEvent event) {
					...
					if (passcode.length() > 3) {
						...
						profileSetupHandler.sendEmptyMessage(USERSECURITYPIN_INVALIDLENGTH);
						...
						Thread thread = new Thread(new Runnable() {
							...
							public void run() {
								...
								if(response.Success) {
									...
									profileSetupHandler.sendEmptyMessage(USERSECURITYPIN_COMPLETE);
								}
								else {
									profileSetupHandler.sendEmptyMessage(USERSECURITYPIN_FAILED);
								}
							}
