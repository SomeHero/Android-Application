...
public class PullAndRefreshListView extends ListView implements
		OnScrollListener {
	...
	public PullAndRefreshListView(Context context) {
		super(context);
		init(context);
	}

	public PullAndRefreshListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	public interface OnRefreshListener {
		 ...
		 * <p>
		 * A call to {@link PullAndRefreshListView #onRefreshComplete()} is
